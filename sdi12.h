...
extern "C"
{
    ...
    {   
        ...
        /**
         * @brief Set up as a slave device to wait for break/mark
         *
         * @param bus[in]               bus object
         * @param out_buffer[out]       buffer to store incoming command
         * @param out_buffer_length[in] maximum available size in buffer values
         *
         */
        esp_err_t (*wait_receive)(sdi12_bus_t *bus, const char *out_buffer, size_t out_buffer_length);

        /**
         * @brief Send a response as a device
         * 
         * @param bus[in]       bus object
         * @param response[in]  response to send to the host (do not include <CR><LF>)
         * 
         */
        esp_err_t (*send_response)(sdi12_bus_t *bus, const char *response);
    };
